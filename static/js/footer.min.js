...
var _gaq=_gaq||[];_gaq.push(["_setAccount","UA-47041310-1"]),_gaq.push(["_trackPageview"]),$(document).ready(function(){$(".hiring a").click(function(){var a=$(this).parent().data("id");_gaq.push(["_trackEvent","Hiring Ads","click",a])}),$(".npme-group a, .npme-details a").click(function(){_gaq.push(["_trackEvent","npm Enterprise Beta","click"])})});
