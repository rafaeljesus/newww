...
!function(e,n,a,t,c,i,s){e.GoogleAnalyticsObject=c,e[c]=e[c]||function(){(e[c].q=e[c].q||[]).push(arguments)},e[c].l=1*new Date,i=n.createElement(a),s=n.getElementsByTagName(a)[0],i.async=1,i.src=t,s.parentNode.insertBefore(i,s)}(window,document,"script","//www.google-analytics.com/analytics.js","ga"),ga("create","UA-53856291-1","auto"),ga("send","pageview"),$(function(){$(".hiring a").click(function(){var e=$(this).parent().data("id");ga("send","event","Hiring Ads","click",e)}),$(".npme-group a, .npme-details a").click(function(){ga("send","event","npm Enterprise","click")})});