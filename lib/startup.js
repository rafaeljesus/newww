...
function makeServer(config) {
  return P.resolve().then(function() {
    ...
    server.persistentRedis = new FailoverRedis(process.env.PERSISTENT_REDIS_URL || process.env.REDIS_URL);
    server.cacheRedis = new RedisPool(process.env.CACHE_REDIS_URL || process.env.REDIS_URL);
